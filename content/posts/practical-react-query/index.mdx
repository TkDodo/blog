...
First of all: React Query does _not_ invoke the _queryFn_ on every re-render, even with the default _staleTime_ of zero.
...
- [Dependent Queries](https://react-query.tanstack.com/docs/guides/queries#dependent-queries)<br />
