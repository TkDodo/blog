...
I've been working on a brand new course together with [ui.dev](https://ui.dev/). If you enjoy the content I've been creating so far, you'll love [query.gg](https://query.gg/?r=dom).
...
Since React Query v5, `refechOnWindowFocus` no
