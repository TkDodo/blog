...
- If your architecture supports server side rendering - consider [fetching on the server](https://tanstack.com/query/v4/docs/framework/react/guides/ssr).
- If you have a router that supports loaders, consider [prefetching there](https://tanstack.com/query/v4/docs/framework/react/guides/ssr).
