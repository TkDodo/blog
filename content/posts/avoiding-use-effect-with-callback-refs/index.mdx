...
bluesky: https://bsky.app/profile/tkdodo.eu/post/3lbjjh6hipc2z
tags:
  - ReactJs
  - JavaScript
  - TypeScript
...
<RcToc id="avoiding-use-effect-with-callback-refs" />
...
const Form = React.forwardRef((props, ref) => {
  ...
  return (
    <form>
      ...
      // 🧐 ref is attached to the input, but it's conditionally
      rendered // so it won't be filled when the above effect runs
      {show && <input ref={ref} />}
    </form>
  )
})
