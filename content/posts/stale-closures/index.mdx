...
>
  ...
  <p>
    Has the shift from "how does `this`/binding work?"-type questions to
    "why is my state stale due to closures?"-type questions made things
    better, worse, or just "same thing but different" ?
  </p>
  <p>
    (Inspired by the questions we see in{' '}
    <Text color="var(--theme-ui-colors-twitterBlue)">@reactiflux</Text>{' '}
    daily)
  </p>
</Tweet>
