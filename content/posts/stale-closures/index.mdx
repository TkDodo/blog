...
description: Let's demystify what stale closures are when working with react hooks with the analogy of taking a photo ...
date: 2022-04-24
...
Calling a function is just looking at the picture and doing what's on it. We will then see everything fom the time when it was created.
