...
The re-render triggered by the _setFilters_ update will pass a different Query Key to TanStack Query, which will make it refetch. I have a more in-depth example in [#1: Practical TanStack Query - Treat the query key like a dependency array](practical-react-query#treat-the-query-key-like-a-dependency-array).
