...
>
  <p>
    <div>🎉🥳 Announcing TanStack Query v4!</div>
    <div>🪪 Name Change!</div>
    <div>🌎 Framework Agnostic!</div>
    <div>
      ✅ <TwitterBlueText>@reactjs</TwitterBlueText> 🚧{' '}
      <TwitterBlueText>@vuejs</TwitterBlueText> 🔜{' '}
      <TwitterBlueText>@solid_js</TwitterBlueText>{' '}
      <TwitterBlueText>@sveltejs</TwitterBlueText>
    </div>
    <div>🔀 Concurrent React Support</div>
    <div>🏕 Offline + Network Mode</div>
    <div>💾 Stable Persisters</div>
    <div>⚡️ Tracked Queries Default / Perf+</div>
    <div>📚 New Docs!</div>
    <div>
      🙏 <TwitterBlueText>@TkDodo</TwitterBlueText>
    </div>
  </p>
</Tweet>
