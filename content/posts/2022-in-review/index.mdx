...
https://twitter.com/TkDodo/status/1537874053989552130
...
We wanted to get it ready before ReactSummit so that Tanner could announce v4 on stage, but it just wasn't enough time. We announced it anyways, and said that it would be ready within 30 days.
...
https://twitter.com/tannerlinsley/status/1549785943837515776
...
To add to the confusion, we accidentally released 4.0.0 of the react-query package as well. This is also what [Theo](https://twitter.com/t3dotgg) was struggling with [in this video](https://www.youtube.com/watch?v=5-1LM2NySR0&t=845s). It was really messy.
