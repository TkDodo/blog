...
With this, you never have to think about re-render again. Of course, tracking the usages has a bit of overhead, so make sure you use this wisely. There are also some limitations to tracked queries, which is why this is an opt-in feature:
