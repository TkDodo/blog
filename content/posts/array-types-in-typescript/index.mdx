...
What, why ? That message makes even less sense than the one from before.When I first got this error in a real codebase, I starred at it for a good 5 minutes.Why wouldn't my keys be strings?
