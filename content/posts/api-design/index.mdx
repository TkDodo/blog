...
>
  <p>
    ...
    they don't mean new stuff, they're a permanent reminder of how many
    times you got the API wrong. Semver doesn't mean MAJOR.MINOR.PATCH,
    it means FAILS.FEATURES.BUGS
  </p>
</Tweet>
...
>
  <p>
    ...
    onSettled callbacks from `useQuery` in v5. I tried very hard to come
    up with a good use-case, but imo there is none.
  </p>
  <p>
...
>
  <p>
    I had an initial knee jerk reaction of thinking this was a bad move.
    But after reading a lot of the reasons as to why keeping them is a
    bad move. I'm on board with this now. It makes sense
  </p>
</Tweet>
