...
bluesky: https://bsky.app/profile/tkdodo.eu/post/3lnvdxtlukk2g
tags:
  - ReactJs
  - React Query
  - Mutations
...
This can be quite straightforward, for example, if the user is interacting with a toggle button. Usually, all we need to do is take the current boolean state and invert it:
