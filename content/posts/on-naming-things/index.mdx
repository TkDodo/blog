...
It's obviously not. Here, the magic number would actually be fine.
...
A good constant name would for example be:
...
But maybe, in the future, we will do something else, or something additional, if we are in this state.
