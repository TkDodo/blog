...
v5 offers a new way to define query options, which can also make `getQueryData` type-safe. Have a look [at the docs](https://tanstack.com/query/v5/docs/react/typescript#typing-query-options) for more information.
