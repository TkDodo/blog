...
Maybe you see a React Class Component that fetches in _componentDidMount_. Wtf, we've moved to [tanstack-query](https://react-query.tanstack.com/) half a year ago, what is this? Or maybe there are some global styles or deprecated components being used. Oh, and this dependency could _really_ need an update...
