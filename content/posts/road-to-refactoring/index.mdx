...
<Tweet
  name="Dominik 🔮"
  handle="TkDodo"
  tweetId="1462821229841338381"
  avatar={<AvatarTkDodo />}
  date={new Date('2021-11-22')}
>
  <p>This is the best flow:</p>
  <p>🐞 find a bug</p>
  <p>🕵️‍♂️ investigate it</p>
  <p>⇆ reproduce it</p>
  <p>🧪 write a failing test for it</p>
  <p>💻 fix it</p>
  <p>🟢 see the green test</p>
  <p>🚀 ship it</p>
</Tweet>
