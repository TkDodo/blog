...
Writing commit messages can be a super-power.
I see commit messages as comments-in-time.
Navigating the git log is like time travelling, and reading the commit messages
...
-   Let's look at the issue then: It's about adding the feature, nothing about this specific setting, obviously.
