...
I do prefer to give each test it's own QueryClientProvider, and create a _new QueryClient_ for each test. That way, tests are completely isolated from each other.
