...
//                     ⬇️ this is the QueryFunctionContext
...
export const useTodos = () => {
  ...
  return useQuery(todoKeys.list(state, sorting), fetchTodo)
}
```
