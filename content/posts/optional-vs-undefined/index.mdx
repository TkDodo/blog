...
Both definitions are exactly the same. If you hover Data1 it the [TypeScript Playground](https://www.typescriptlang.org/play?#code/C4TwDgpgBAIghsOBGKBeKAlCBjA9gJwBMAeAZ2HwEsA7AcwBooBXaga2twHdqA+AKFCRYCOACY0UAN5QA2qwggoNKOSp0AugC5mbDtygBfIA), it even expands to the Data2 syntax. It is perfectly fine to use either way, and it's totally up to developer or team preference to decide what they prefer. Most people I know prefer the first way because it's shorter, and you don't need to invent a name like _key_ - and so do I.
