...
&#x200B;<Emph>Update</Emph>: The docs have been updated and _do not_ primarily
...
>
  <p>
    ...
    exactly right, TypeScript does refinement on the types of individual
    symbols. Once you split them apart, it can't keep track of the
    relationship any more. Doing this in general would be
    computationally hard. It can also be hard for people.
  </p>
</Tweet>

&#x200B;<Emph>Update</Emph>: TypeScript 4.6 has added [control flow analysis for
...
&#x200B;<Emph>Update</Emph>: TypeScript 4.7 has added [Improved Function
