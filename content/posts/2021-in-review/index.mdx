...
>
  ...
  <p>
    Open source work has taken up a good part of my daily routine now, which can
    be quite distracting. I will now try to bundle it with a fixed block each
    Friday. This will likely reduce my responsiveness, so please bear with me
  </p>
</Tweet>
...
>
  <p>
    ...
    into the official react-query docs 🎊 You can now read an excerpt of all my
    RQ related articles here: https://react-query.tanstack.com/community/tkdo...
  </p>
  <p>
...
>
  <p>
    Okay apparently it’s not obvious to everybody that you DO NOT need to copy
    data from react-query anywhere else (context, redux,…) to access it
    everywhere. I will have to write a blog post about it I guess (and maybe
    update the docs?)…
  </p>
</Tweet>
