...
That was also the reason why I started my [TanStack Query related series of blog posts](./practical-react-query), which currently spans over 13 articles, as I have gotten a lot of questions around TanStack Query.
...
The tweet that got the most impressions this year (**74k**) was one I've quickly written on my phone after answering a certain question for the Nth time - which also lead to me writing [TanStack Query as a State Manager](./react-query-as-a-state-manager) - arguably one of my best received articles:
