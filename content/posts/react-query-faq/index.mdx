...
Remember: React Query doesn't know (or care) about status codes or network requests at all. It needs a resolved or rejected Promise that the _queryFn_ needs to provide.
...
I definitely prefer the callbacks, and you can read more about differnt ways to handle errors in [#11: React Query Error Handling](react-query-error-handling).
