...
I definitely prefer the callbacks, and you can read more about differnt ways to handle errors in [#11: TanStack Query Error Handling](react-query-error-handling).
