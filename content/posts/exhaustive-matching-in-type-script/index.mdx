...
&#x200B;<Emph>Update</Emph>: Since [React
18.0](https://reactjs.org/blog/2022/03/29/react-v18.html), React [can
render undefined](https://github.com/facebook/react/pull/21869). It
behaves the same as rendering `null` now, so this fallthrough is not
...
In TypeScripts type system, never is its [bottom type](https://en.wikipedia.org/wiki/Bottom_type).
