...
They'll give you a cleaner interface, and you don't need to write the selector in all the places where you want to subscribe to just one value in the store. Also, it avoids accidentally subscribing to the entire store:
