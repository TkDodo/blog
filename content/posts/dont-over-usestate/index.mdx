...
Or, as [@ryanflorence](https://cdb.reacttraining.com/react-inline-functions-and-performance-bdff784f5578) put it:

> You need proof that something is fast, not that it is slow
