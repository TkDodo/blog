...
Starting with v5, you can us the [useMutationState](https://tanstack.com/query/v5/docs/react/reference/useMutationState) hook to share mutation state across components.
