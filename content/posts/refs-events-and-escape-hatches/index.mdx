...
<HsToc id="refs-events-and-escape-hatches" />
...
>
  <p>
    Do you want to use the proposed `useEvent` hook now with
    TypeScript?
  </p>
  <p>
    Here you go:{' '}
    <TwitterBlueText>gist.github.com/diegohaz/69509...</TwitterBlueText>
  </p>
  <p>
    <TweetImage>
      <UseEvent />
