...
>
  ...
  <p>
    ...
    now. I think I remember @rickhanlonii mentioning something like
    this but I can't find any evidence now.
  </p>
...
>
  <p>
    Had a great discussion with @_gsathya about React19, the suspense
    changes and the react compiler. I felt like my concerns were truly
    heard and the feedback appreciated, so thank you for that 🙏
  </p>
  <p>
    <TweetImage>
      <SathyaAndMe />
