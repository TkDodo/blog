...
<MemoToc id="the-uphill-battle-of-memoization" />
...
>
  ...
  <p>Solution:</p>
  <p>1. I wrapped each table in memo.</p>
  <p>2. I wrapped the functions passed down in useCallback.</p>
  <p>MUCH faster.</p>
</Tweet>
