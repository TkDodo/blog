...
<TsError>
  Argument of type '&#123; variant: string; &#125; is not assignable to
  parameter of type 'Props'. Types of property 'variant' are incompatible. Type
  'string' is not assignable to type 'Variant'.(2345)
</TsError>
...
Argument of type 'readonly ["foo", "bar", "baz"]' is not assignable to
parameter of type 'string[]'.

The type 'readonly ["foo", "bar", "baz"]' is
'readonly' and cannot be assigned to the mutable type 'string[]'.(2345)
