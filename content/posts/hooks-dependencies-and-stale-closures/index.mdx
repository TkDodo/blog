...
import { HsToc } from "components/hs-toc";
...
<HsToc id="hooks-dependencies-and-stale-closures" />
...
>
  ...
  <p>
    Has the shift from "how does `this`/binding work?"-type questions to "why is
    my state stale due to closures?"-type questions made things better, worse,
    or just "same thing but different" ?
  </p>
  <p>(Inspired by the questions we see in @reactiflux daily)</p>
</Tweet>
...
export default function App() {
  ...
  const [logged, setLogged] = React.useState(count);
