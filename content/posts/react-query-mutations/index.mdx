...
I'm showing some more examples of direct updates and the combination of both approaches in [#8: Effective TanStack Query Keys](effective-react-query-keys#structure).
