...
<Attribution name="Brett Jordan" url="https://unsplash.com/@brett_jordan" />
...
- Favor Composition.
- [Compound Components are great, but should be type-safe.](building-type-safe-compound-components)
