...
<Attribution
  name="Ricardo Loaiza"
  url="https://unsplash.com/@rickpekar"
/>
...
>
  <p>
    <div>📢 Announcing TanStack Query v5 🎉🥳</div>
    <div>🤝 unified object API</div>
    <div>📈 simplified, optimistic updates</div>
    <div>♻️ sharable mutation state</div>
    <div>🔀 suspense and streaming w/ RSC</div>
    <div>♾ improved infinite queries</div>
    <div>⚡️ ~20 % smaller</div>
    <div>🛠️ new agnostic devtools</div>
    <div>💾 fine-grained persistence</div>
  </p>
  <p>
    <TweetImage>
      <TanStackQueryV5 />
...
>
  <p>
    The selfie inception 🤳{' '}
    <TwitterBlueText>#ReactSummit</TwitterBlueText>
  </p>
  <p>
    <TweetImage>
      <SelfieInception />
...
>
  <p>
    It takes 62 seconds to start the dev server for my gatsby blog 😭.
    When have I suffered enough to tackle a re-write?
  </p>
</Tweet>
