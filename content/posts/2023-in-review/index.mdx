...
>
  ...
  <p>🤝 unified object API</p>
  <p>📈 simplified, optimistic updates</p>
  <p>♻️ sharable mutation state</p>
  <p>🔀 suspense and streaming w/ RSC</p>
  <p>♾ improved infinite queries</p>
  <p>⚡️ ~20 % smaller</p>
  <p>🛠️ new agnostic devtools</p>
  <p>💾 fine-grained persistence</p>
  <p>
    <TweetImage>
      <TanStackQueryV5 />
    </TweetImage>
