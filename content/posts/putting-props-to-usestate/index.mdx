...
Once could also argue that the scope of the draft email state is now too big.
...
But please, don't use the syncing state "solution".
...
<Comments>Which solution do you prefer? leave a comment below ⬇️</Comments>
