...
<Attribution name="Randy Tarampi" url="https://unsplash.com/@randytarampi" />
...
>
  <p>
    ...
    I'm feeling mostly afraid of server components and suspense.
  </p>
  <p>
    "How will this work with react-query" is a good question. It feels like I'm
    supposed to have an answer but I don't. Huge imposter syndrome rn
  </p>
</Tweet>
...
>
  <p>
    i'm sure @Mappletons can do better but this is what i see in my head every
    time i see "devs just go back and forth in endless cycles" comments
  </p>
  <p>
    <TweetImage>
      <CynicsVsBuilders />
...
![Buzz Lightyear meme: tradeoffs, tradeoffs everywhere](./tradeoffs.jpeg)
