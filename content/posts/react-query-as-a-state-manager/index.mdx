...
<RqToc id="react-query-as-a-state-manager" />
...
<Translations
  translations={[
    ...
    {
      language: 'Español',
      url: 'https://rubenvara.io/react-query/react-query-gestor-estado/',
    },
    {
      language: 'Russian',
      url: 'https://my-blogs-mdx.aniia.dev/blog/state-manager',
    },
  ]}
/>
...
<Highlight>
  ...
  You will not see a network request for fresh data, no matter how
  often you want to retrieve it.
</Highlight>
