...
>
  <p>
    ...
    context over to zustand. It was the same amount of code. The lib is &lt;
    1kb.
  </p>
  <p>
    ⚛️ Don't use context for state management. Use it for dependency injection
    only. The right tool for the job!
  </p>
  <p>zustand.surge.sh</p>
</Tweet>
...
![Component tree show props passing over two components vs. context passing where the grand-child can read it directly](./props-vs-context.png)
