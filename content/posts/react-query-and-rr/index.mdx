...
If you want to explore this topic some more, I've implemented the app from the tutorial and added React Query on top of it - you can find it [the examples of the official docs](https://tanstack.com/query/v4/docs/examples/react/react-router).
