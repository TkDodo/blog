...
>
  ...
  <p>https://trpc.io/docs/client/re...</p>
</Tweet>
...
We've since introduced `staleTime: 'static'` to support this use-case out of the box. You can now set staleTime to 'static' to never trigger a refetch, even if the Query is invalidated manually.
