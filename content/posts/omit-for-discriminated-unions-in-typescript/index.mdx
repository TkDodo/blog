...
description: Why TypeScript’s built-in Omit breaks discriminated unions, and how a distributive version preserves them.
date: 2025-11-22
banner: ./omit.jpg
tags:
  - TypeScript
...
<img
  src="./omit.jpg"
  alt="Guitar picks with different color backgrounds yellow and blue"
/>

<Attribution
  name="Rombo"
  url="https://unsplash.com/@rombo_guitar_picks"
/>
...
<TsError>
  ...
  <br />
  &nbsp;&nbsp;Type 'boolean | undefined' is not assignable to type
  'false | undefined'.
  <br />
...
That made little sense to me when I read it the first time - after all, I'm just <Emph>composing</Emph> types with `Omit`, and it worked before. 🤔 So what's changed?
...
They likely existed at some ponit and were just left behind during a cleanup. And if you know me, you know I'm not a fan of dead code, so this turned into a nice little opportunity to tidy things up. ✂️
